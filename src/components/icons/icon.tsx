...
/**
 * Centralized icon component using inline SVG paths.
 * Keeps the bundle lean — no icon library dependency.
...
const ICON_PATHS: Record<IconName, string> = {
  'layout-dashboard':
    'M4 5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5Zm10 0a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V5ZM4 15a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-4Zm10-2a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-6Z',
  'arrow-left-right':
    'M8 3 4 7l4 4M4 7h16M16 21l4-4-4-4m4 4H4',
  'pie-chart':
    'M21.21 15.89A10 10 0 1 1 8 2.83M22 12A10 10 0 0 0 12 2v10z',
  target:
    'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm0-6a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z',
  'building-2':
    'M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18M2 22h20M6 12H4a2 2 0 0 0-2 2v8M18 12h2a2 2 0 0 1 2 2v8M10 6h4M10 10h4M10 14h4M10 18h4',
  sparkles:
  ...
  wallet:
    'M21 12V7H5a2 2 0 0 1 0-4h14v4M3 5v14a2 2 0 0 0 2 2h16v-5M18 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z',
